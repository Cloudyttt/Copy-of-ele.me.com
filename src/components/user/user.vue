<template>
  <div class="user" ref="wrapper">
    ...
    <div v-show="userShow">
          ...
          <div class="uesr-top">
            <div class="uesr-top-left" v-show="userShow">
              <p>我的</p>
            </div>
            <div class="uesr-top-right">
              <div class="notice-icon"><img src="./notice.png"></div>
              <div class="setting-icon" v-on:click="showsetting()"><img src="./setting.png"></div>
            </div>
          </div>

          <div class="login-btn" v-on:click="showlogin()">
            <div class="user-login">
              <div class="login-icon"><img src="./user.png"></div>
              <div class="login-main">
                <div>
                  <p class="font20">{{username}}</p>
                  <p class="font16">{{userid}}</p>
                </div>
    ...
    <div v-show="loginShow" class="login-show">
      <div class="login">
        ...
        <div class="login-cnt">
          ...
          <input type="button" class="login-botton" value="登陆" v-on:click="userlogin()">
          <div class="forget">
            <p>忘记密码?</p>
          </div>
        </div>
...
<style type="text/css">
  ...
  .login-botton, .register-botton{
    color: white;
    background-color: rgb(77, 192, 96);
    height: 48px;
    width: 90%;
    border: 0;
    outline: none;
